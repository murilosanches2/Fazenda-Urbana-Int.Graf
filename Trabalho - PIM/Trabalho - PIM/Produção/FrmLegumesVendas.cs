...
{
    public partial class FrmLegumesVendas : Form
    {
        ...
        private void FrmLegumesVendas_Load(object sender, EventArgs e)
        {
            ListarGD();
        }
        ...
        {
            con.AbrirConexao();
            sql = "SELECT * FROM legumesven ORDER BY data DESC, hora DESC";
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            con.AbrirConexao();
            sql = "INSERT INTO legumesven (ervilha, abobora, pimentao, data, hora, preco) VALUES (@ervilha, @abobora, @pimentao, @data, @hora, @preco)";
            cmd = new MySqlCommand(sql, con.con);
            cmd.Parameters.AddWithValue("@ervilha", txtAlface.Text);
            cmd.Parameters.AddWithValue("@abobora", txtRucula.Text);
            cmd.Parameters.AddWithValue("@pimentao", txtBrocolis.Text);
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            con.AbrirConexao();
            sql = "UPDATE legumesven SET ervilha=@ervilha, abobora=@abobora, pimentao=@pimentao, data=@data, hora=@hora, preco=@preco WHERE id=@id";
            cmd = new MySqlCommand(sql, con.con);
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                con.AbrirConexao();
                sql = "DELETE FROM legumesven WHERE id=@id";
                cmd = new MySqlCommand(sql, con.con);
                cmd.Parameters.AddWithValue("@id", id);
                cmd.ExecuteNonQuery();
                con.FecharConexao();
        ...
        {
            con.AbrirConexao();
            sql = "SELECT * FROM legumesven WHERE data LIKE @data ORDER BY data ASC";
            cmd = new MySqlCommand(sql, con.con);
