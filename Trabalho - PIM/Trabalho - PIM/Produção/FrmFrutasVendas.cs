...
{
    public partial class FrmFrutasVendas : Form
    {
        ...
        private void FrmFrutasVendas_Load(object sender, EventArgs e)
        {
            ListarGD();
        }
        ...
        {
            con.AbrirConexao();
            sql = "SELECT * FROM frutasven ORDER BY data DESC, hora DESC";
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            con.AbrirConexao();
            sql = "INSERT INTO frutasven (maca, morango, uva, data, hora, preco) VALUES (@maca, @morango, @uva, @data, @hora, @preco)";
            cmd = new MySqlCommand(sql, con.con);
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            con.AbrirConexao();
            sql = "UPDATE frutasven SET maca=@maca, morango=@morango, uva=@uva, data=@data, hora=@hora, preco=@preco WHERE id=@id";
            cmd = new MySqlCommand(sql, con.con);
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                con.AbrirConexao();
                sql = "DELETE FROM frutasven WHERE id=@id";
                cmd = new MySqlCommand(sql, con.con);
                cmd.Parameters.AddWithValue("@id", id);
                cmd.ExecuteNonQuery();
                con.FecharConexao();
        ...
        {
            con.AbrirConexao();
            sql = "SELECT * FROM frutasven WHERE data LIKE @data ORDER BY data ASC";
            cmd = new MySqlCommand(sql, con.con);
